...
static char c000000[] = "#181819"; /* Dragon background placeholder */

static char normfgcolor[] =
    "#c5c9c5"; /* Dragon main foreground (fuji white/gray) */
static char normbgcolor[] =
    "#121213"; /* Dragon dark background for regular bar */
static char normbordercolor[] =
    "#0d0c0c"; /* Very dark border blending into background */
static char normfloatcolor[] =
    "#282727"; /* Inactive floating window border */

static char selfgcolor[] =
    "#121213"; /* Dark text contrasting against dragon accent */
static char selbgcolor[] =
    "#8ea4a2"; /* Dragon Aqua/Cyan highlight for active tag/item */
static char selbordercolor[] =
    "#8ea4a2"; /* Active focused window border */
static char selfloatcolor[] =
    "#8a9a86"; /* Dragon Sage green for active floating windows */

static char titlenormfgcolor[] =
    "#7a8382"; /* Muted gray-green for unfocused window titles */
static char titlenormbgcolor[] = "#121213"; /* Matches normal bar background */
static char titlenormbordercolor[] = "#0d0c0c";
static char titlenormfloatcolor[] = "#282727";

static char titleselfgcolor[] =
    "#8ea4a2"; /* Vibrant dragon teal/cyan for active window title */
static char titleselbgcolor[] =
    "#121213"; /* Seamless bar background */
static char titleselbordercolor[] = "#8ea4a2";
static char titleselfloatcolor[] = "#8a9a86";

static char tagsnormfgcolor[] =
    "#625e5a"; /* Dimmed out inactive tags */
static char tagsnormbgcolor[] = "#121213";
static char tagsnormbordercolor[] = "#0d0c0c";
static char tagsnormfloatcolor[] = "#282727";

static char tagsselfgcolor[] =
    "#121213"; /* Dark text for active tag indicator */
static char tagsselbgcolor[] =
    "#8ea4a2"; /* Accent block background for active tag */
static char tagsselbordercolor[] = "#8ea4a2";
static char tagsselfloatcolor[] = "#8a9a86";

static char hidnormfgcolor[] = "#393836"; /* Dark text for hidden windows */
static char hidselfgcolor[] =
    "#7a8382"; /* Muted text when focusing hidden items */
static char hidnormbgcolor[] = "#121213";
static char hidselbgcolor[] = "#121213";

static char urgfgcolor[] =
    "#121213"; /* Dark text for urgent block readability */
static char urgbgcolor[] =
    "#c4746e"; /* Kanagawa Dragon Red for urgent alerts */
static char urgbordercolor[] = "#c4746e"; /* Red border alert */
static char urgfloatcolor[] = "#c4746e";
 ...
 */
	...
	{ MODKEY|Mod4Mask,                  XK_k,           inplacerotate,          {.i = -2} }, // same as rotatestack
