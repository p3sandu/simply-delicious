 ...
 */
static char *font =
    "jetbrains mono nl:pixelsize=26:antialias=true:autohint=true";
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = {
    ...
    "Iosevka Nerd Font Propo:pixelsize=22:antialias=true:autohint=true"};
#endif // FONT2_PATCH
...
static const char *colorname[] = {
    ...
    /* More colors can be added after 255 for foreground, background, cursor */
    "#1a1b26", /* 256: default background */
    "#a9b1d6", /* 257: default foreground */
};
